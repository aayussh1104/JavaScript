...
// != vs !==
console.log(num4 != num5); // check if its not equal to and does not check data type

console.log(num4 !== num5); // check if it is not equal to and also checks the data type
